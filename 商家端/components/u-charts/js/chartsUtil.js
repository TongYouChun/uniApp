...
let chartsUtil = {
	getSampleData(){
		...
		var Data={
			...
			ColumnB:{categories:['1月', '2月', '3月', '4月', '5月', '6月','7月', '8月', '9月', '10月', '11月', '12月'],series:[{name: '田小光',data:['170', '140', '160', '120', '89', '160','220', '160', '120', '100', '230', '300']}]},
			...
			Pie:{series:[{ name: '雀巢优享10L', data: 150 }, { name: '雀巢优享10L', data: 58 }, { name: '娃哈哈优享19L', data: 8 }, { name: '其它品种19L', data: 8}]},
